...
type ModelDocument struct {
	ID DocumentID `gorm:"column:id;primarykey;type:string;uniqueIndex:idx_document_composite,priority:1"`
	...
	ModelCollectionID modelcollections.CollectionID `gorm:"primarykey;uniqueIndex:idx_document_composite,priority:2"` // foreign key to model collection
	ModelCollection   modelcollections.ModelCollection

	ModelProjectID modelprojects.ProjectID `gorm:"primarykey;uniqueIndex:idx_document_composite,priority:3"` // foreigh key to model project
