...
// NewHTTPClientWithConfig creates a new rest col API documentations HTTP client,
// using a customizable transport config.
func NewHTTPClientWithConfig(formats strfmt.Registry, cfg *TransportConfig) *RestColAPIDocumentations {
...
// New creates a new rest col API documentations client
func New(transport runtime.ClientTransport, formats strfmt.Registry) *RestColAPIDocumentations {
	// ensure nullable parameters have default
	if formats == nil {
