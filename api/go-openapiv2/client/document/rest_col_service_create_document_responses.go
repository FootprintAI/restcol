...
func (o *RestColServiceCreateDocumentReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *RestColServiceCreateDocumentOK) Error() string {
	...
	return fmt.Sprintf("[POST /v1/projects/{projectId}/newdoc][%d] restColServiceCreateDocumentOK %s", 200, payload)
}
...
func (o *RestColServiceCreateDocumentDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/projects/{projectId}/newdoc][%d] RestColService_CreateDocument default %s", o._statusCode, payload)
}
