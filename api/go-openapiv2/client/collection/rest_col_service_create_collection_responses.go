...
func (o *RestColServiceCreateCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *RestColServiceCreateCollectionOK) Error() string {
	...
	return fmt.Sprintf("[POST /v1/projects/{projectId}/collections][%d] restColServiceCreateCollectionOK %s", 200, payload)
}
...
func (o *RestColServiceCreateCollectionDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /v1/projects/{projectId}/collections][%d] RestColService_CreateCollection default %s", o._statusCode, payload)
}
