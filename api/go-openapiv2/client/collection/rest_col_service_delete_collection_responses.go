...
func (o *RestColServiceDeleteCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *RestColServiceDeleteCollectionOK) Error() string {
	...
	return fmt.Sprintf("[DELETE /v1/projects/{projectId}/collections/{collectionId}][%d] restColServiceDeleteCollectionOK %s", 200, payload)
}
...
func (o *RestColServiceDeleteCollectionDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[DELETE /v1/projects/{projectId}/collections/{collectionId}][%d] RestColService_DeleteCollection default %s", o._statusCode, payload)
}
