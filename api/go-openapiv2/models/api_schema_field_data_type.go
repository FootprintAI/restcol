...
const (
	...
	APISchemaFieldDataTypeSCHEMAFIELDDATATYPEOBJECT APISchemaFieldDataType = "SCHEMA_FIELD_DATA_TYPE_OBJECT"

	// APISchemaFieldDataTypeSCHEMAFIELDDATATYPEARRAY captures enum value "SCHEMA_FIELD_DATA_TYPE_ARRAY"
	APISchemaFieldDataTypeSCHEMAFIELDDATATYPEARRAY APISchemaFieldDataType = "SCHEMA_FIELD_DATA_TYPE_ARRAY"
)
...
func init() {
	...
	if err := json.Unmarshal([]byte(`["SCHEMA_FIELD_DATA_TYPE_NONE","SCHEMA_FIELD_DATA_TYPE_STRING","SCHEMA_FIELD_DATA_TYPE_NUMBER","SCHEMA_FIELD_DATA_TYPE_INTEGER","SCHEMA_FIELD_DATA_TYPE_BOOL","SCHEMA_FIELD_DATA_TYPE_OBJECT","SCHEMA_FIELD_DATA_TYPE_ARRAY"]`), &res); err != nil {
		panic(err)
	}
	for _, v := range res {
