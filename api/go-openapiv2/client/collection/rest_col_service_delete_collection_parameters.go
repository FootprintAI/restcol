...
// WithForce adds the force to the rest col service delete collection params
func (o *RestColServiceDeleteCollectionParams) WithForce(force *bool) *RestColServiceDeleteCollectionParams {
	o.SetForce(force)
	return o
}

// SetForce adds the force to the rest col service delete collection params
func (o *RestColServiceDeleteCollectionParams) SetForce(force *bool) {
	o.Force = force
}
