...
func (o *RestColServiceGetCollectionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *RestColServiceGetCollectionOK) Error() string {
	...
	return fmt.Sprintf("[GET /v1/projects/{projectId}/collections/{collectionId}][%d] restColServiceGetCollectionOK %s", 200, payload)
}
...
func (o *RestColServiceGetCollectionDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/projects/{projectId}/collections/{collectionId}][%d] RestColService_GetCollection default %s", o._statusCode, payload)
}
