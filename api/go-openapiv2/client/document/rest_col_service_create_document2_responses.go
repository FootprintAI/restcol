...
func (o *RestColServiceCreateDocument2Reader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
	...
	case 200:
		...
		return result, nil
	default:
		result := NewRestColServiceCreateDocument2Default(response.Code())
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
...
func NewRestColServiceCreateDocument2OK() *RestColServiceCreateDocument2OK {
	return &RestColServiceCreateDocument2OK{}
}
...
func (o *RestColServiceCreateDocument2OK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewRestColServiceCreateDocument2Default(code int) *RestColServiceCreateDocument2Default {
	return &RestColServiceCreateDocument2Default{
		_statusCode: code,
	}
}
...
func (o *RestColServiceCreateDocument2Default) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
