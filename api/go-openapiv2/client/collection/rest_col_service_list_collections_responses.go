...
func (o *RestColServiceListCollectionsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (any, error) {
...
func (o *RestColServiceListCollectionsDefault) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /v1/projects/{projectId}/collections][%d] RestColService_ListCollections default %s", o._statusCode, payload)
}
